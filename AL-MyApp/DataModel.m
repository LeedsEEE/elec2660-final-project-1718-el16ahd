...
- (instancetype)init {
    ...
    if (self) {
        ...
        Wonder *Chichen    = [[Wonder alloc] init]; // Inititating an object named "Chichen" as an instance of the Wonder class. This object will have the same properties as the class and it is here that we give its specific info. The same is done for the other wonders.
