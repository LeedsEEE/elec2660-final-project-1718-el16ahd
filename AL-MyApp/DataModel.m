...
- (instancetype)init
{
    ...
    if (self) {
        ...
        Wonder *Chichen = [[Wonder alloc] init]; // Inititating an object named "Chichen" as an instance of the Wonder class.
        ...
        // Chichen Itza info taken from http://whc.unesco.org/en/list/483
        ...
        // The Colosseum info taken from https://www.rome.info/colosseum/
        ...
        // The Great Wall of China info taken from https://www.travelchinaguide.com/china_great_wall/
        ...
        // Machu Picchu info taken from http://whc.unesco.org/en/list/274
        ...
        // Pyramids of Giza info taken from http://www.history.com/topics/ancient-history/the-egyptian-pyramids
        ...
        // Petra info copied from http://whc.unesco.org/en/list/326
